...
- v0.4: Improve calendar planning, draft saving, and pilot-store workflows (in progress: weekly draft queue, today's tasks, draft filters, category sync, chat proxy, and shared fallback constants added)

...
| v0.6.22 | `b8ca06f` | Local browser verified, production confirmation pending, 2026-06-07 KST | Recommendation cards disclose rule-based, zero-cost calculation and wait for at least three ratings before proposing an improvement priority. |

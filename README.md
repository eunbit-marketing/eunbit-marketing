...
- Production baseline: v0.6.24 pilot action checklist confirmed
...
| v0.6.24 | `6d7c7c6` | Confirmed on live site, 2026-06-08 KST | Add a pilot action checklist that turns the remaining work into send, confirm, and collect-three-ratings steps. |
...
- v0.6.10: Clarify what the four One-click Studio mood buttons do and make the Naver auto/direct selection behavior explicit.
...
- v0.6.24: Turn the remaining pilot work into a visible execution checklist: send the direct link, confirm the owner tested it, and collect three real ratings.

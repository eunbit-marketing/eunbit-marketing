...
- Production baseline: v0.5.6 pilot-clarity release candidate
...
- v0.5: Prepare paid MVP packaging around 9,900 KRW/month (started: Free usage counters, Pro comparison, pilot pricing modal, 3-minute onboarding result flow, pilot proposal page, AI-backed Naver Place writing, one-click Instagram+Naver kit, and clearer pilot copy-ready language)
